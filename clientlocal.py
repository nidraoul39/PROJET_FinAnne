...
def menu_principal(error):
    ...
    bouton_connexion = Button(root_menu, text="Se connecter", width=20, height=3, bg="#2ecc71", fg="white", font=("Arial", 15), command=lambda: main(root_menu,ip="127.0.0.1",port=5555))
